...
use callApi\Forms\ProfilesForm;
use callApi\Models\Profiles;

/**
 * callApi\Controllers\ProfilesController
...
class ProfilesController extends ControllerBase
{
    ...
    public function searchAction()
    {
        ...
        if ($this->request->isPost()) {
            $query = Criteria::fromInput($this->di, 'callApi\Models\Profiles', $this->request->getPost());
