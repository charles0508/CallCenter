<?php
namespace callApi\Api\Aip;
use callApi\Api\Aip\AipHttpClient;
use callApi\Api\Aip\AipBCEUtil;
use callApi\Api\Aip\AipImageUtil;
/*
...
class AipBase {
     ...
     */
    public function onConstruct($appId, $apiKey, $secretKey){
